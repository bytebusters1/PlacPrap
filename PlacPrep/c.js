...
const quizEnd = () => {
    ...
    document.getElementsByClassName("container")[0].innerHTML = `
        <div class="col">
            <h3 class="w-100">Hi, you've scored ${correct} / ${total} <span class="emoji">${emoji}</span></h3>
            <p>${message}</p>
    ...
    emojiElement.style.animation = 'bounce 1s infinite';
    ...
    colElement.style.transition = 'opacity 1s';
    setTimeout(() => {
        colElement.style.opacity = 1;
    }, 100);

    // Add slide-in animation to the score
    const scoreElement = document.querySelector('h3');
    scoreElement.style.transform = 'translateX(-100%)';
    scoreElement.style.transition = 'transform 1s';
    setTimeout(() => {
